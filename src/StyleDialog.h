...
// this is known to have issues on Windows Vista
...
public:
	...
	void	SetTitle(CString Title)	{ m_csTitle = Title; }
	...
	void		SetOpaqueColor(COLORREF clr) { m_OpaqueColor = clr; }
	...
	afx_msg void OnSdClose()		{ OnCancel(); }
	afx_msg void OnSdMinimize()		{ ShowWindow(SW_MINIMIZE); }
	afx_msg void OnSdAbout()		{ SendMessage(WM_SYSCOMMAND, IDM_ABOUTBOX, 0); }
	...
	int		m_Controls;
	void	SetControls(int ctrls)	{ m_Controls = ctrls; }
